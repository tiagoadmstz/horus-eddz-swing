...
import com.cooperstandard.shadow.ShadowRenderer;
...
public class TableStatusTeste extends JTable {

    private BufferedImage imageShadow;

    public TableStatusTeste() {
        setRowHeight(50);
    ...
    public Component prepareRenderer(TableCellRenderer tcr, int i, int i1) {
        if (i1 == 13) {
            TableCell_Status cell = new TableCell_Status(getValueAt(i, 13).toString());
            return cell;
        } else {
            String values = "";
            ...
            TableCellStatus cell = new TableCellStatus(values);
            return cell;
        }
    }
