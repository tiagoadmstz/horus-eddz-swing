...
public class Utilidades {
    ...
    public static void selecionarArquivoSalvarOutraPastaEPegarPathNovo(String titulo) {
        ...
        try {
            ...
            File pathDestino = new File("C:/imagensSistema/");
            ...
            File arquivoDestino = new File("C:/imagensSistema/".concat(arquivoSelecionado.getName()));
...
// voce precisa modificar o final do método de seleção para retornar o caminho do 
//arquivo novo para você setar no objeto e salvar no banco