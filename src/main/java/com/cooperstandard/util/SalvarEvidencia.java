...
public class SalvarEvidencia {
    ...
    public String selecionarArquivoSalvarOutraPastaEPegarPathNovo(String titulo) {
        ...
        try {
            ...
            File pathDestino = new File("J:\\Sistema de Documentacao/Evidencias/");
            ...
            File arquivoDestino = new File("J:\\Sistema de Documentacao/Evidencias/".concat(arquivoSelecionado.getName()));
