...
public class SalvarImagem {
    ...
    public String selecionarArquivoSalvarOutraPastaEPegarPathNovo(String titulo) {
        ...
        fileChooser.setFileFilter(new FileNameExtensionFilter("Imagens JPEG", "jpg", "jpeg", "png", "PNG"));
        ...
        try {
            ...
            File pathDestino = new File("L:\\\\E.P.E/Sistema de Documentacao/Imagem Ficha/");
            ...
            File arquivoDestino = new File("L:\\\\E.P.E/Sistema de Documentacao/Imagem Ficha/".concat(arquivoSelecionado.getName()));
