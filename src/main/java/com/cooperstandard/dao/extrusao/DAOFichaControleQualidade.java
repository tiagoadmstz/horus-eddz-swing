 ...
 * @author rsouza10
 */
public class DAOFichaControleQualidade extends ConexaoSql {

    public int salvarFichaControleQualidadeDAO(ModelFichaControleQualidade pModelFichaControleQualidade) {
        try {
            this.conectar();
    ...
    public ModelFichaControleQualidade getFichaControleQualidadeDAO(int pCodigo) {
    ...
    public ModelFichaControleQualidade getFichaControleQualidadeDAO(String pNome) {
        ModelFichaControleQualidade modelFichaControleQualidade = new ModelFichaControleQualidade();
        try {
            this.conectar();
            this.executarSQL(
                    ...
                    + "Cad_Espec_Teste"
                    + " WHERE"
                    + " ESP_TESTE= '" + pNome + "' and OPE_SETOR='Extrusão'"
                    + ";"
            );
            while (this.getResultSet().next()) {
                modelFichaControleQualidade.setId(this.getResultSet().getInt(1));
    ...
    public ArrayList<ModelFichaControleQualidade> getListaFichaControleQualidadeDAO(String perfil) {
        ...
        try {
            ...
            while (this.getResultSet().next()) {
                ...
                modelFichaControleQualidade.setLab(this.getResultSet().getString(19));
                modelFichaControleQualidade.setPendencia_alter(this.getResultSet().getString(20));
                modelFichaControleQualidade.setEsp_composto(this.getResultSet().getInt(21));
    ...
    public ArrayList<ModelFichaControleQualidade> getListaFichaControleQualidadeEditDAO(String perfil) {
        ...
        try {
            ...
            while (this.getResultSet().next()) {
                ...
                modelFichaControleQualidade.setPendencia_alter(this.getResultSet().getString(20));
                modelFichaControleQualidade.setEsp_composto(this.getResultSet().getInt(21));
                modelFichaControleQualidade.setAlter_indentificacao(this.getResultSet().getInt(22));
    ...
    public boolean atualizarFichaControleQualidadeDAO(ModelFichaControleQualidade pModelFichaControleQualidade) {
        try {
            this.conectar();
    ...
    public boolean excluirFichaControleQualidadeDAO(int pCodigo) {
        try {
            this.conectar();
    ...
    public boolean updatStatus(ModelFichaControleQualidade pModelFichaControleQualidade, String perfilupdat) {
        try {
            this.conectar();
            return this.executarUpdateDeleteSQL(
    ...
    public boolean updateProducaoStatus(ModelFichaControleQualidade pModelFichaControleQualidade, String perfilupdat) {
        try {
            this.conectar();
    ...
    public boolean CopiaHistorico(String perfilupdat) {
        try {
            this.conectar();
            return this.executarUpdateDeleteSQL(
                    ...
                    + "HISTO_FREQUENCIA,HISTO_UNID_FREQUENCIA,HISTO_PRODUTO,HISTO_ORIGEM,HISTO_TIPO_ESPEC,HISTO_ESPEC_COMPLEMENTO,HISTO_FREQ_COMPLETO,HISTO_LAB,HISTO_COMPLEMENTO,HISTO_RESPONSAVEL,HISTO_PENDENCIA,HISTO_DATA_HISTO,HISTO_OBSERVACAO,HISTO_DATE_VALID,ALTER_IDENTIFICACAO,HISTO_HORA,HISTO_COMPOSTO, HISTO_STATUS) SELECT  ORDEM,ESP_LINHA ,ESP_MATERIAL ,ESP_TESTE ,ESP_EQUIPAMENTO ,MINIMO ,MAXIMO ,UNID_MEDIDA ,TEXTO ,"
                    + "REFERENCIA ,FREQUENCIA ,UNID_FREQUENCIA,PRODUTO ,ORIGEM ,TIPO_ESPEC ,ESPEC_COMPLETO ,FREQ_COMPLETO ,LAB ,COMPLEMENTO,RESPONSAVEL_ALTER,PENDENCIA_ALTER,DATA_ALTER,OBSERVACAO_ALTER,DATE_VALIDE_ALTER,ALTER_IDENTIFICACAO,HORA_ALTER,ESP_COMPOSTO,STATUS FROM Cad_Espec_Teste WHERE ESP_MATERIAL='" + perfilupdat + "'"
                    + ";"
            );
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public boolean CopiaFicha(String perfilupdat) 
    ...
    
    {
        try {
            ...
            return this.executarUpdateDeleteSQL(
                    ...
                    + "REFERENCIA ,FREQUENCIA ,UNID_FREQUENCIA,PRODUTO ,ORIGEM ,TIPO_ESPEC ,ESPEC_COMPLETO ,FREQ_COMPLETO ,LAB ,COMPLEMENTO,ESP_COMPOSTO,STATUS )"
                    ...
                    + "LAB ,COMPLEMENTO,ESP_COMPOSTO,STATUS FROM Cad_Espec_Teste WHERE ESP_MATERIAL='" + perfilupdat + "'"
                    + ";"
            );
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public boolean DeletaFichaControle(String perfilupdat) {
        try {
            this.conectar();
            return this.executarUpdateDeleteSQL(
    ...
    public boolean DeletaFichaControleProducao(String perfilupdat) {
        try {
            this.conectar();
            return this.executarUpdateDeleteSQL(
    ...
    public boolean DeletaTesteRemovido(String perfilupdat) {
        try {
            this.conectar();
            return this.executarUpdateDeleteSQL(
    ...
    public boolean DataAlteracao(String perfilupdat) {
        try {
            this.conectar();
            java.util.Date currentDate = GregorianCalendar.getInstance().getTime();
            DateFormat df = new SimpleDateFormat("yyyy/MM/dd");
    ...
    public ArrayList<ModelFichaControleQualidade> getListaFichaemAbertoAlterDAO() {
        ...
        try {
            ...
            this.executarSQL(
                    ...
                    + "ESP_MATERIAL,"
                    + "RESPONSAVEL_ALTER "
                    + "FROM Cad_Espec_Teste where (PENDENCIA_ALTER ='Alteração Qualidade') and (RESPONSAVEL_ALTER !=NULL OR RESPONSAVEL_ALTER <> 'NULL' OR RESPONSAVEL_ALTER !='' OR RESPONSAVEL_ALTER <> '') order by DATA_ALTER DESC"
                    + ";"
            );
            while (this.getResultSet().next()) {
                modelFichaControleQualidade = new ModelFichaControleQualidade();
    ...
    public ModelFichaControleQualidade getFichaDAO(int pPerfilaberto) {
        ModelFichaControleQualidade modelFichaControleQualidade = new ModelFichaControleQualidade();
        try {
            this.conectar();
            this.executarSQL(
