...
public class DAOOperacao extends ConexaoSql {
    ...
    public int salvarOperacaoDAO(ModelOperacao pModelOperacao) {
        try {
            this.conectar();
    ...
    public ModelOperacao getOperacaoDAO(int pCodigo) {
    ...
    public ModelOperacao getOperacaoDAO(String pNome) {
        ModelOperacao modelOperacao = new ModelOperacao();
        try {
            this.conectar();
            this.executarSQL(
                    ...
                    + "Cad_Operacao"
                    + " WHERE"
                    + " OPERACAO= '" + pNome + "' and OPE_SETOR='Extrusão'"
                    + ";"
            );
            while (this.getResultSet().next()) {
                modelOperacao.setId_operacao(this.getResultSet().getInt(1));
    ...
    public ArrayList<ModelOperacao> getListaOperacaoDAO() {
        ...
        try {
            ...
            this.executarSQL(
                    ...
                    + "DATA_CRIACAO"
                    + " FROM"
                    + " Cad_Operacao where  OPE_SETOR= 'Extrusão' ORDER BY ORDEM "
                    + ";"
            );
    ...
    public boolean atualizarOperacaoDAO(ModelOperacao pModelOperacao) {
        try {
            this.conectar();
    ...
    public boolean excluirOperacaoDAO(int pCodigo) {
        try {
            this.conectar();
