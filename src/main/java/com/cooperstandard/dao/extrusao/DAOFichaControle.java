 ...
 * @author rsouza10
 */
public class DAOFichaControle extends ConexaoSql {

    public int salvarFichaControleDAO(ModelFichaControle pModelFichaControle) {
        try {
            this.conectar();
    ...
    public ModelFichaControle getFichaControleDAO(int pCodigo) {
    ...
    public ModelFichaControle getFichaControleDAO(String pNome) {
        ModelFichaControle modelFichaControle = new ModelFichaControle();
        try {
            this.conectar();
            this.executarSQL(
    ...
    public ArrayList<ModelFichaControle> getListaFichaControleDAO(String perfil) {
        ...
        try {
            ...
            while (this.getResultSet().next()) {
                ...
                modelFichaControle.setLab(this.getResultSet().getString(19));
                modelFichaControle.setPendencia_alter(this.getResultSet().getString(20));
                modelFichaControle.setEsp_composto(this.getResultSet().getInt(21));
    ...
    public ArrayList<ModelFichaControle> getListaFichaControleComboDAO() {
        ArrayList<ModelFichaControle> listaFichaControle = new ArrayList();
        ModelFichaControle modelFichaControle = new ModelFichaControle();
        try {
            this.conectar();
    ...
    public ArrayList<ModelFichaControle> getListaFichaControleEditDAO(String perfil) {
        ArrayList<ModelFichaControle> listaFichaControle = new ArrayList();
        ModelFichaControle modelFichaControle = new ModelFichaControle();
        try {
            this.conectar();
            ...
            while (this.getResultSet().next()) {
                ...
                modelFichaControle.setPendencia_alter(this.getResultSet().getString(20));
                modelFichaControle.setEsp_composto(this.getResultSet().getInt(21));
                modelFichaControle.setAlter_indentificacao(this.getResultSet().getInt(22));
                listaFichaControle.add(modelFichaControle);
            }
    ...
    public boolean atualizarFichaControleDAO(ModelFichaControle pModelFichaControle) {
        try {
            this.conectar();
    ...
    public boolean excluirFichaControleDAO(int pCodigo) {
        try {
            this.conectar();
    ...
    public boolean updatStatus(String perfilupdat, String pendencia, String responsavel) {
        try {
            this.conectar();
            return this.executarUpdateDeleteSQL(
    ...
    public boolean updatStatusAlterar(ModelFichaControle pModelFichaControle, String perfilupdat) {
        try {
            this.conectar();
...
//            String value0 = timeString;
    ...
    public boolean updatecopiaStatus(ModelFichaControle pModelFichaControle, String perfilupdat) {
        try {
            this.conectar();
            java.util.Date currentDate = GregorianCalendar.getInstance().getTime();
            DateFormat df = new SimpleDateFormat("yyyy-MM-dd");
            ...
            String values = dateString;
            return this.executarUpdateDeleteSQL(
                    "UPDATE Cad_Espec_Teste set PENDENCIA_ALTER='" + pModelFichaControle.getPendencia_alter() + "',RESPONSAVEL_ALTER='" + pModelFichaControle.getResponsavel_alter() + "', DATA_ALTER ='" + values + "', HORA_ALTER='" + value0 + "', OBSERVACAO_ALTER = '" + pModelFichaControle.getObservacao_alter() + "',  STATUS= '" + pModelFichaControle.getStatus() + "' where ESP_MATERIAL='" + perfilupdat + "'"
                    + ";"
            );
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public ArrayList<ModelFichaControle> getListaFichaemAbertoDAO() {
        ArrayList<ModelFichaControle> listaFichaControle = new ArrayList();
        ModelFichaControle modelFichaControle = new ModelFichaControle();
        try {
            this.conectar();
            this.executarSQL(
                    ...
                    + "RESPONSAVEL_ALTER,"
                    + "STATUS "
                    + "FROM Qry_Espec_Teste where (PENDENCIA_ALTER is null or PENDENCIA_ALTER='' or PENDENCIA_ALTER = null) and SETOR='Extrusão'"
                    + ";"
            );
            while (this.getResultSet().next()) {
                modelFichaControle = new ModelFichaControle();
    ...
    public ArrayList<ModelFichaControle> getListaFichaemAbertoAlterDAO() {
        ArrayList<ModelFichaControle> listaFichaControle = new ArrayList();
        ModelFichaControle modelFichaControle = new ModelFichaControle();
        try {
            this.conectar();
            this.executarSQL(
                    ...
                    + "ESP_MATERIAL,"
                    + "RESPONSAVEL_ALTER "
                    + "FROM Qry_Espec_Teste where (PENDENCIA_ALTER ='Alteração') and (RESPONSAVEL_ALTER !=NULL OR RESPONSAVEL_ALTER <> 'NULL' OR RESPONSAVEL_ALTER !='' OR RESPONSAVEL_ALTER <> '') and SETOR = 'Extrusão' order by DATA_ALTER DESC"
                    + ";"
            );
            while (this.getResultSet().next()) {
                modelFichaControle = new ModelFichaControle();
    ...
    public ArrayList<ModelFichaControle> getListaFichaemAbertoCopiaDAO() {
        ArrayList<ModelFichaControle> listaFichaControle = new ArrayList();
        ModelFichaControle modelFichaControle = new ModelFichaControle();
        try {
            this.conectar();
            this.executarSQL(
                    ...
                    + "ESP_MATERIAL,"
                    + "RESPONSAVEL_ALTER "
                    + "FROM Qry_Espec_Teste where (PENDENCIA_ALTER ='Cópia') and (RESPONSAVEL_ALTER !=NULL OR RESPONSAVEL_ALTER <> 'NULL' OR RESPONSAVEL_ALTER !='' OR RESPONSAVEL_ALTER <> '') and SETOR = 'Extrusão' order by DATA_ALTER DESC"
                    + ";"
            );
            while (this.getResultSet().next()) {
                modelFichaControle = new ModelFichaControle();
    ...
    public ModelFichaControle getFichaDAO(int pPerfilaberto) {
        ModelFichaControle modelFichaControle = new ModelFichaControle();
        try {
            this.conectar();
            this.executarSQL(
    ...
    public ArrayList<ModelFichaControle> getListaFichaValidacaoDAO() {
        ArrayList<ModelFichaControle> listaFichaControle = new ArrayList();
        ModelFichaControle modelFichaControle = new ModelFichaControle();
        try {
            this.conectar();
