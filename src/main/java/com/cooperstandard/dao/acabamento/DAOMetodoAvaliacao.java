...
public class DAOMetodoAvaliacao extends ConexaoSql {
    ...
    public int salvarMetodoAvaliacaoAcDAO(ModelMetodoAvaliacao pModelMetodoAvaliacao) {
        try {
            this.conectar();
    ...
    public ModelMetodoAvaliacao getMetodoAvaliacaoAcDAO(int pCodigo) {
    ...
    public ModelMetodoAvaliacao getMetodoAvaliacaoAcDAO(String pNome) {
        ModelMetodoAvaliacao modelMetodoAvaliacao = new ModelMetodoAvaliacao();
        try {
            this.conectar();
            this.executarSQL(
    ...
    public ArrayList<ModelMetodoAvaliacao> getListaMetodoAvaliacaoAcDAO() {
        ...
        try {
            ...
            this.executarSQL(
                    ...
                    + "SETOR"
                    + " FROM"
                    + " Cad_Metodo_Avaliacao where SETOR='Acabamento' ORDER BY ID"
                    + ";"
            );
    ...
    public boolean atualizarMetodoAvaliacaoAcDAO(ModelMetodoAvaliacao pModelMetodoAvaliacao) {
        try {
            this.conectar();
    ...
    public boolean excluirMetodoAvaliacaoAcDAO(int pCodigo) {
        try {
            this.conectar();
