...
public class DAOTeste extends ConexaoSql {
    ...
    public int salvarTesteAcDAO(ModelTeste pModelTeste) {
        try {
            this.conectar();
    ...
    public ModelTeste getTesteAcDAO(int pCodigo) {
    ...
    public ModelTeste getTesteAcDAO(String pNome) {
        ModelTeste modelTeste = new ModelTeste();
        try {
            this.conectar();
            this.executarSQL(
    ...
    public ArrayList<ModelTeste> getListaTesteAcDAO() {
        ...
        try {
            ...
            this.executarSQL(
                    ...
                    + "COD_TESTE"
                    + " FROM"
                    + " Qry_Teste where OPE_SETOR='Acabamento' ORDER BY ORDEM"
                    + ";"
            );
    ...
    public boolean atualizarTesteAcDAO(ModelTeste pModelTeste) {
        try {
            this.conectar();
    ...
    public boolean excluirTesteAcDAO(int pCodigo) {
        try {
            this.conectar();
