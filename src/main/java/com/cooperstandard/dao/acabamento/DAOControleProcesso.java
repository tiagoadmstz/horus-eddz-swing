...
public class DAOControleProcesso extends ConexaoSql {
    ...
    public int salvarControleProcessoAcDAO(ModelControleProcesso pModelControleProcesso) {
        try {
            this.conectar();
    ...
    public ModelControleProcesso getControleProcessoAcDAO(int pCodigo) {
    ...
    public ModelControleProcesso getControleProcessoAcDAO(String pNome) {
        ModelControleProcesso modelControleProcesso = new ModelControleProcesso();
        try {
            this.conectar();
            this.executarSQL(
    ...
    public ArrayList<ModelControleProcesso> getListaControleProcessoAcDAO() {
        ...
        try {
            ...
            this.executarSQL(
                    ...
                    + "SETOR "
                    + " FROM"
                    + " Cad_Controle_Processo where SETOR='Acabamento' ORDER BY DESC_CONTROLE"
                    + ";"
            );
    ...
    public boolean atualizarControleProcessoAcDAO(ModelControleProcesso pModelControleProcesso) {
        try {
            this.conectar();
    ...
    public boolean excluirControleProcessoAcDAO(int pCodigo) {
        try {
            this.conectar();
