...
public class DAOHistorico extends ConexaoSql {
    ...
    public ArrayList<ModelHistorico> getListaHistoricoAcDAO() {
        ...
        try {
            ...
            this.executarSQL(
                    ...
                    + "HISTO_RESPONSAVEL"
                    + " FROM "
                    + "Qry_FichaControleHisto where (ALTER_IDENTIFICACAO='4'or ALTER_IDENTIFICACAO='5' or ALTER_IDENTIFICACAO='6') and SETOR='Acabamento' ORDER BY HISTO_DATA_HISTO asc"
            );
    ...
    public ArrayList<ModelHistorico> getLista2HistoricoAcDAO() {
        ArrayList<ModelHistorico> listaHistorico = new ArrayList();
        ModelHistorico modelHistorico = new ModelHistorico();
        try {
            this.conectar();
            this.executarSQL(
                    ...
                    + "HISTO_HORA "
                    + "FROM"
                    + " Qry_FichaControleHisto where SETOR = 'Acabamento' ORDER BY HISTO_DATA_HISTO DESC,HISTO_HORA DESC"
            );
    ...
    public ArrayList<ModelHistorico> getListaMaterialHistoAcDAO() {
        ArrayList<ModelHistorico> listaHistorico = new ArrayList();
        ModelHistorico modelHistorico = new ModelHistorico();
        try {
            this.conectar();
            this.executarSQL(
                    "Select distinct HISTO_MATERIAL from Qry_FichaControleHisto where SETOR='Acabamento' order by HISTO_MATERIAL asc"
            );
    ...
    public ArrayList<ModelHistorico> getListaLinhaHistoAcDAO() {
        ArrayList<ModelHistorico> listaHistorico = new ArrayList();
        ModelHistorico modelHistorico = new ModelHistorico();
        try {
            this.conectar();
            this.executarSQL(
                    "Select distinct HISTO_LINHA from Qry_FichaControleHisto where SETOR='Acabamento' order by HISTO_LINHA asc"
            );
    ...
    public ModelHistorico getHistoricoAcDAO(Time pHora) {
        ModelHistorico modelHistorico = new ModelHistorico();
        try {
            this.conectar();
            this.executarSQL(
    ...
    public ArrayList<ModelHistorico> getListaVersaoAcDAO(String perfil, String data, String hora) {
        ArrayList<ModelHistorico> listaHistorico = new ArrayList();
        ModelHistorico modelHistorico = new ModelHistorico();
        try {
            this.conectar();
