 ...
 * @author rsouza10
 */
public class ViewUnidFreq extends javax.swing.JFrame {
    ...
    public ViewUnidFreq(JFrame frame) {
        initComponents();
        carregaUnidFreq();
        solicitante = frame;
        tbUnidFreq.getTableHeader().setDefaultRenderer(new HeaderRenderer(tbUnidFreq));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewUnidFreq.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewUnidFreq().setVisible(true);
            }
        });
    }
