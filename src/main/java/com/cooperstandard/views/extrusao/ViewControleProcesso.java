 ...
 * @author rsouza10
 */
public class ViewControleProcesso extends javax.swing.JFrame {
    ...
    public ViewControleProcesso(JFrame frame) {
        initComponents();
        carregaControleProcesso();
        ListarMetodoAvaliacao();
        solicitante = frame;
    ...
    private void jLabel10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel10MouseClicked
        ViewMetodoAvaliacao vm = null;
        if (ControleInstancias.isInstaced(ViewMetodoAvaliacao.class)) {
            vm = (ViewMetodoAvaliacao) ControleInstancias.getInstance(ViewMetodoAvaliacao.class.getName(), ViewMetodoAvaliacao.class);
            vm.setSolicitante(this);
        } else {
            vm = new ViewMetodoAvaliacao(this);
        }
        vm.setVisible(true);
    ...
    private void excluirControleProcesso() {
        ...
        if (opcao == JOptionPane.OK_OPTION) {
            if (controllerControleProcesso.excluirControleProcessoController(codigo)) {
    ...
    private boolean salvarControleProcesso() {
        ...
        if (controllerControleProcesso.salvarControleProcessoController(modelControleProcesso) > 0) {
    ...
    private boolean recuperarControleProcesso() {
        ...
        int codigo = (Integer) tbControleProcesso.getValueAt(linha, 0);
        try {
            modelControleProcesso = controllerControleProcesso.getControleProcessoController(codigo);
    ...
    private boolean alterarControleProcesso() {
        ...
        modelControleProcesso.setMetodo_avaliacao(this.cbMetodo.getSelectedItem().toString());
        modelControleProcesso.setSetor(this.cbSetor.getSelectedItem().toString());
        if (controllerControleProcesso.atualizarControleProcessoController(modelControleProcesso)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewControleProcesso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
