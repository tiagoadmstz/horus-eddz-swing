 ...
 * @author rsouza10
 */
public class ViewUnidMed extends javax.swing.JFrame {

    private static final long serialVersionUID = 7816762919552796680L;
    ...
    public ViewUnidMed(JFrame frame) {
        initComponents();
        carregaUnidMedida();
        solicitante = frame;
        tbUnidMedida.getTableHeader().setDefaultRenderer(new HeaderRenderer(tbUnidMedida));
    ...
    private boolean salvarUnidadeMed() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewUnidMed.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewUnidMed().setVisible(true);
            }
        });
    }
