 ...
 * @author rsouza10
 */
public class ViewFichaControleAc extends javax.swing.JFrame {

    private static final long serialVersionUID = 2889705834357671952L;

    ModelFichaControle modelFichaControle = new ModelFichaControle();
    ControllerFichaControleAc controllerFichaControle = new ControllerFichaControleAc();
    ...
    public ViewFichaControleAc() {
        initComponents();
    }

    public ViewFichaControleAc(String _perfil, String _linha, String _status, String _responsavel, String _divisao) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lbOrigem1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        lbOrigem1.setText("Amostra:");
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                ...
                                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        ...
                                                        .addComponent(txtOrdem, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE))
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        ...
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                ...
                                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        ...
                                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                                .addComponent(cbUnidFreq, javax.swing.GroupLayout.PREFERRED_SIZE, 247, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                ...
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        .addComponent(lbOrigem1)
                                                        .addComponent(txtAmostra, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE))
                                                .addGap(11, 11, 11)
                                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        .addComponent(lbObservacaoQL)
                                                        .addComponent(txtObservacaoQL, javax.swing.GroupLayout.DEFAULT_SIZE, 267, Short.MAX_VALUE))
                                                .addGap(19, 19, 19))
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        .addComponent(txtObs)
        ...
        tbFicha.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[]{
                        "ID", "Ordem", "Célula", "Material", "Equipamento", "Desc. Teste", "Cod. Teste", "Obseração", "Tipo", "Espec. Mín.", "Espec. Máx.", "Espec. Unid.", "Espec. Texto", "Referência", "Frequência", "Freq. Unid.", "Produto", "Origem", "Lab.", "Amostra", "IDENTIFICACAO"
                }
        ) {
...
//        }
    ...
    private void jLabel12MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel12MouseClicked
        ...
        if (respsota.equals("Material")) {
            ...
            if (ControleInstancias.isInstaced(ViewMaterialAc.class)) {
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        getValorOrdena().stream().forEach(mr -> controllerFichaControle.atualizarFichaControleAcController((ModelFichaControle) mr));
    ...
    private void excluirTeste() {
        ...
        if (opcao == JOptionPane.OK_OPTION) {
            if (controllerFichaControle.excluirFichaControleAcController(codigo)) {
    ...
    private boolean updatStatus() {
        for (int i = 0; i < tbFicha.getRowCount(); i++) {
            ...
            if (controllerFichaControle.updateStatusFichaControleAcController(perfil, status, responsavel)) {
    ...
    private boolean updatStatusAlterar() {
        for (int i = 0; i < tbFicha.getRowCount(); i++) {
            ...
            if (controllerFichaControle.updateStatusAlterarFichaControleAcController(modelFichaControle, perfil)) {
                JOptionPane.showMessageDialog(this, "Registros enviado com sucesso!");
                this.desabilitarCampos();
                this.carregaFichaControle();
                limparDados();
    ...
    private boolean updatecopiaStatus() {
        ...
        for (int i = 0; i < tbFicha.getRowCount(); i++) {
            ...
            if (controllerFichaControle.updatecopiaStatusFichaControleAcController(modelFichaControle, perfil)) {
                JOptionPane.showMessageDialog(this, "Registros enviado com sucesso!");
                this.desabilitarCampos();
                this.carregaFichaControle();
                limparDados();
    ...
    private boolean alterarExcluir() {
        ...
        try {
            ...
            Logger.getLogger(ViewFichaControleAc.class.getName()).log(Level.SEVERE, null, ex);
        }

        if (controllerFichaControle.atualizarFichaControleAcController(modelFichaControle)) {
            JOptionPane.showMessageDialog(this, "Registro excluido com sucesso!");
            this.desabilitarCampos();
            this.carregaFichaControle();
            limparDados();
    ...
    private boolean salvarFicha() {
        ...
        modelFichaControle.setAmostra(this.txtAmostra.getText());
        ...
        if (controllerFichaControle.salvarFichaControleAcController(modelFichaControle) > 0) {
    ...
    private boolean recuperarFichaControle() {
        ...
        int codigo = (Integer) tbFicha.getValueAt(linhatb, 0);
        try {
            modelFichaControle = controllerFichaControle.getFichaControleAcController(codigo);
            ...
            this.txtAmostra.setText(modelFichaControle.getAmostra());
            return true;
        } catch (Exception e) {
    ...
    private void carregaFichaControle() {
        if (divisao.equals("Novo") || divisao.equals("Cópia")) {
            listaModelFichaControle = controllerFichaControle.getListaFichaControleAcController(perfil);
        }
        if (divisao.equals("Alteração")) {
            listaModelFichaControle = controllerFichaControle.getListaFichaControleEditAcController(perfil);
        }
        ...
        for (int i = 0; i < cont; i++) {
            modelo.addRow(new Object[]{
                    ...
                    listaModelFichaControle.get(i).getAmostra(),
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewFichaControleAc.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewFichaControleAc().setVisible(true);
            }
        });
    }
