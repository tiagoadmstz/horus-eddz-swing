 ...
 * @author rsouza10
 */
public class ViewEquipamentoAc extends javax.swing.JFrame {

    private static final long serialVersionUID = 4425846719031363062L;
    ...
    public ViewEquipamentoAc(JFrame frame) {
        initComponents();
        carregaEquipamento();
        listarOperacao();
        solicitante = frame;
    ...
    private void txtBuscaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscaKeyReleased
        ...
        sorter.setRowFilter(RowFilter.regexFilter(text, 2, 3));
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        ViewOperacaoAc vm = null;
        if (ControleInstancias.isInstaced(ViewOperacaoAc.class)) {
            vm = (ViewOperacaoAc) ControleInstancias.getInstance(ViewOperacaoAc.class.getName(), ViewOperacaoAc.class);
            vm.setSolicitante(this);
        } else {
            vm = new ViewOperacaoAc(this);
        }
        vm.setVisible(true);
 ...
 final AguardeGerandoRelatório carregando = new AguardeGerandoRelatório();
    ...
    private void excluirEquipamento() {
        ...
        if (opcao == JOptionPane.OK_OPTION) {
            if (controllerEquipamento.excluirEquipamentoAcController(codigo)) {
    ...
    private boolean salvarEquipamento() {
        ...
        if (controllerEquipamento.salvarEquipamentoAcController(modelEquipamento) > 0) {
    ...
    private boolean recuperarEquipamento() {
        ...
        int codigo = (Integer) tbEquipamento.getValueAt(linha, 0);
        try {
            modelEquipamento = controllerEquipamento.getEquipamentoAcController(codigo);
    ...
    private boolean alterarEquipamento() {
        ...
        modelEquipamento.setEqu_operacao(this.cbOperacao.getSelectedItem().toString());
        modelEquipamento.setEquipamento(this.txtEquipamento.getText());
        if (controllerEquipamento.atualizarEquipamentoAcController(modelEquipamento)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewEquipamentoAc.class
