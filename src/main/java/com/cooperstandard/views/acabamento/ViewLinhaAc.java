 ...
 * @author rsouza10
 */
public class ViewLinhaAc extends javax.swing.JFrame {
    ...
    public ViewLinhaAc(JFrame frame) {
        initComponents();
        setLocationRelativeTo(null);
        this.carregaLinha();
        solicitante = frame;
    ...
    private void initComponents() {
        ...
        tbLinha.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Ordem", "Célula", "Tipo da Linha", "Setor"
            }
        ) {
    ...
    private void excluirLinha() {
        ...
        if (opcao == JOptionPane.OK_OPTION) {
            if (controllerLinhaAc.excluirLinhaAcController(codigo)) {
                JOptionPane.showMessageDialog(this, "Registro excluido com sucesso!");
                if (solicitante != null) {
                    if (solicitante instanceof ViewMaterialAc) {
                        ViewMaterialAc vp = (ViewMaterialAc) solicitante;
    ...
    private boolean salvarLinha() {
        ...
        if (controllerLinhaAc.salvarLinhaAcController(modelLinha) > 0) {
    ...
    private boolean recuperarLinha() {
        ...
        int codigo = (Integer) tbLinha.getValueAt(linha, 0);
        try {
            modelLinha = controllerLinhaAc.getLinhaAcController(codigo);
    ...
    private boolean alterarLinha() {
        ...
        modelLinha.setTipo_linha(this.txtTipo.getText());
        modelLinha.setSetor(this.cbSetor.getSelectedItem().toString());
        if (controllerLinhaAc.atualizarLinhaAcController(modelLinha)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewLinhaAc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
