 ...
 * @author rsouza10
 */
public class ViewCabecalhoFmeaAc extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Cadastro de Cabeçalho FMEA");
        ...
        tbCabecalhoFmea.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Célula", "N. Plano", "Contato Chave", "Equipe Principal", "Data"
            }
        ) {
    ...
    private void excluirLinha() {
        ...
        if (opcao == JOptionPane.OK_OPTION) {
            if (controllerLinha.excluirLinhaAcController(codigo)) {
    ...
    private boolean salvarLinha() {
        ...
        if (controllerLinha.salvarLinhaAcController(modelLinha) > 0) {
    ...
    private boolean recuperarLinha() {
        ...
        int codigo = (Integer) tbCabecalhoFmea.getValueAt(linha, 0);
        try {
            modelLinha = controllerLinha.getLinhaAcController(codigo);
...
//            JOptionPane.showMessageDialog(this, "Código inválido ou nenhum registro selecionado", "Aviso", JOptionPane.WARNING_MESSAGE);
    ...
    private boolean alterarLinha() {
        ...
        if (controllerLinha.atualizarLinhaAcController(modelLinha)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewCabecalhoFmeaAc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewCabecalhoFmeaAc().setVisible(true);
            }
        });
    }
