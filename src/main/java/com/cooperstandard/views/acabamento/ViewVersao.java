    ...
    public void CopiaFichaControle() {
        try {
            ...
            String query1 = "INSERT INTO Ficha_Controle (ORDEM,ESP_LINHA ,ESP_MATERIAL ,ESP_TESTE ,ESP_EQUIPAMENTO ,MINIMO ,MAXIMO ,UNID_MEDIDA ,TEXTO ,"
                    ...
                    + "LAB ,COMPLEMENTO,ESP_COMPOSTO,STATUS FROM Cad_Espec_Teste WHERE ESP_MATERIAL='" + txt_perfil.getText() + "'";
    ...
    public void Copiadados_histo() {
        try {
            ...
            String query1 = "INSERT INTO Cad_Espec_Teste (ORDEM,ESP_LINHA ,ESP_MATERIAL ,ESP_TESTE ,ESP_EQUIPAMENTO ,MINIMO ,MAXIMO ,UNID_MEDIDA ,TEXTO ,REFERENCIA ,FREQUENCIA ,"
                    ...
                    + "DATE_VALIDE_ALTER,ALTER_IDENTIFICACAO,HORA_ALTER,ESP_COMPOSTO,STATUS) SELECT ORDEM,HISTO_LINHA,HISTO_MATERIAL,HISTO_TESTE,HISTO_EQUIPAMENTO,HISTO_MINIMO,HISTO_MAXIMO,"
                    ...
                    + "ALTER_IDENTIFICACAO,HISTO_HORA,HISTO_COMPOSTO,HISTO_STATUS FROM Histo_Ficha_Controle WHERE HISTO_MATERIAL='" + txt_perfil.getText() + "' and HISTO_DATA_HISTO='" + txt_data.getText() + "' and HISTO_HORA='" + txt_hora.getText() + "'";
...
//                JOptionPane.showMessageDialog(null, e);
    ...
    private void initComponents() {
        ...
        setTitle("Painel Versão Ficha de Controle");
