...
import com.cooperstandard.controller.acabamento.ControllerHistorico;
 ...
 * @author rsouza10
 */
public class ViewAcabamento extends javax.swing.JFrame {
    ...
    ControllerProducaoAc controllerProducao = new ControllerProducaoAc();
    ...
    public void Copiadados() {
        try {
            ...
            String query1 = "INSERT INTO Cad_Espec_Teste (ORDEM ,ESP_LINHA ,ESP_MATERIAL ,ESP_TESTE ,ESP_EQUIPAMENTO ,MINIMO ,MAXIMO ,UNID_MEDIDA ,TEXTO ,"
                    ...
                    + "FREQ_COMPLETO ,LAB ,COMPLEMENTO ,ESP_COMPOSTO,STATUS,'Alteração' as PENDENCIA,'" + txtAlteraSolicitante.getText() + "' as RESPONSAVEL, '" + values + "' AS DATA, AMOSTRA FROM Ficha_Controle WHERE ESP_MATERIAL='" + cbAlteraMaterial.getSelectedItem() + "' and ESP_LINHA='" + cbAlteraLinha.getSelectedItem() + "'";
    ...
    public void Copiaficha() {
        try {
            ...
            Connection con = new ConexaoSql().getCon();
            String query1 = "INSERT INTO Cad_Espec_Teste (ORDEM,ESP_LINHA,ESP_MATERIAL,ESP_TESTE ,ESP_EQUIPAMENTO ,MINIMO ,MAXIMO ,UNID_MEDIDA ,TEXTO ,"
                    + "REFERENCIA ,FREQUENCIA ,UNID_FREQUENCIA,PRODUTO ,ORIGEM ,TIPO_ESPEC ,ESPEC_COMPLETO ,FREQ_COMPLETO ,LAB ,COMPLEMENTO,ESP_COMPOSTO,PENDENCIA_ALTER, AMOSTRA )SELECT  ORDEM,ESP_LINHA  ,ESP_MATERIAL ,ESP_TESTE ,ESP_EQUIPAMENTO ,MINIMO ,MAXIMO ,UNID_MEDIDA ,TEXTO ,REFERENCIA ,FREQUENCIA ,UNID_FREQUENCIA ,PRODUTO ,ORIGEM ,TIPO_ESPEC ,ESPEC_COMPLETO ,"
                    + "FREQ_COMPLETO ,LAB ,COMPLEMENTO,ESP_COMPOSTO,'Cópia' as PENDENCIA, AMOSTRA FROM Ficha_Controle WHERE ESP_MATERIAL='" + cbCopiaMaterial.getSelectedItem() + "'";
            PreparedStatement st = con.prepareStatement(query1);
            ResultSet rs = st.executeQuery();
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        tbNova.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Data", "Célula", "Material", "Responsável", "Status", "Deletar Ficha"
            }
        ) {
        ...
        lbCopiaLinha2.setText("Célula:");

        cbCopiaLinha2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        cbCopiaMaterial2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        tbVersao.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Data Alteração", "Hora", "Célula", "Material"
            }
        ) {
            Class[] types = new Class [] {
    ...
    private void cbNovaLinhaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbNovaLinhaActionPerformed
        try {
            ...
            Connection con = new ConexaoSql().getCon();
            String query1 = "Select * from Qry_Material where MAT_LINHA= ? and SETOR ='Acabamento' and MATERIAL NOT IN(Select ESP_MATERIAL from Ficha_Controle) ORDER BY MATERIAL ASC ";
            PreparedStatement st = con.prepareStatement(query1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (cbNovaLinha.getSelectedIndex() == -1) {
            ...
            ViewFichaControleAc tela2 = new ViewFichaControleAc(cbNovaMaterial.getSelectedItem().toString(), cbNovaLinha.getSelectedItem().toString(), status, txtNovaSolicitante.getText(), "Novo");
    ...
    private void cbAlteraLinhaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbAlteraLinhaActionPerformed
        try {
            ...
            Connection con = new ConexaoSql().getCon();
            String query1 = "Select distinct ESP_MATERIAL from Qry_FichaControle where ESP_LINHA= ? and SETOR ='Acabamento' order by ESP_MATERIAL";
            PreparedStatement st = con.prepareStatement(query1);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (cbCopiaLinha.getSelectedIndex() == -1) {
            ...
            Copiaficha();
            updateperfillinha();
            ViewFichaControleAc t = new ViewFichaControleAc(cbCopiaMaterial2.getSelectedItem().toString(), cbCopiaLinha2.getSelectedItem().toString(), "Cópia de Ficha", txtCopiaSolicitante.getText(), "Cópia");
            t.setVisible(true);
            dispose();
        }
    ...
    private void cbVersaoLinhaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbVersaoLinhaActionPerformed
        try {
            ...
            Connection con = new ConexaoSql().getCon();
            String query1 = "Select distinct HISTO_MATERIAL from Qry_FichaControleHisto where HISTO_LINHA= ? and SETOR = 'Acabamento' order by HISTO_MATERIAL asc ";
            PreparedStatement st = con.prepareStatement(query1);
...
//
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        if (cbAlteraLinha.getSelectedIndex() == -1) {
            ...
            Copiadados();
            ViewFichaControleAc t = new ViewFichaControleAc(cbAlteraMaterial.getSelectedItem().toString(), cbAlteraLinha.getSelectedItem().toString(), "Protótipo", txtAlteraSolicitante.getText(), "Alteração");
            t.setVisible(true);
            dispose();
        }
    ...
    private void listarMaterialHistorico() {
        listaModelHistorico = controllerHistorico.getListaMaterialHistoAcController();
        cbVersaoMaterial.removeAllItems();
    ...
    private void listarLinhaHistorico() {
        listaModelHistorico = controllerHistorico.getListaLinhaHistoAcController();
    ...
    private void listarLinhaProducao() {
        listaModelProducao = controllerProducao.getListaLinhaAcController();
    ...
    private void listarPerfilProducao() {
        listaModelProducao = controllerProducao.getListaPerfilAcController();
        cbAlteraMaterial.removeAllItems();
        cbCopiaMaterial.removeAllItems();
        for (int i = 0; i < listaModelProducao.size(); i++) {
    ...
    private boolean recuperarHistorico() {
        ...
        try {
            modelHistorico = controllerHistorico.getHistoricoAcController(hora);
    ...
    private boolean recuperarFichaControle() {
        ...
        try {
            modelFichaControle = controllerFichaControle.getFichaAcController(perfil);
    ...
    private void carregaTabela() {
        listaModelFichaControle = controllerFichaControle.getListaFichaemAbertoAcAlterController();
    ...
    private void carregaTabela2() {
        listaModelHistorico = controllerHistorico.getLista2HistoricoAcController();
    ...
    private void carregaTabela3() {
        listaModelFichaControle = controllerFichaControle.getListaFichaemAbertoAcController();
    ...
    private void carregaTabela4() {
        listaModelFichaControle = controllerFichaControle.getListaFichaemAbertoCopiaAcController();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAcabamento.class
