 ...
 * @author rafael
 */
public class Cad_PainelMixing extends javax.swing.JInternalFrame {
...
//        jButton1.setVisible(false);
        ...
        this.combo_composto.removeAllItems();
        try {

            
            Connection con = new ConexaoSql().getCon();
            Statement Sent = con.createStatement();
            ResultSet rs = Sent.executeQuery("Select * from Cad_Composto");
            combo_composto.addItem("Selecione...");
            while (rs.next()) {
                this.combo_composto.addItem(rs.getString("COMPOSTO"));
            }
        } catch (Exception e) {
    ...
    public void updateA() {
        try {
            ...
            Connection con = new ConexaoSql().getCon();
            String sql = "UPDATE Ficha_Controle set MINIMO=?,MAXIMO=?,ESPEC_COMPLETO=? where ESP_COMPOSTO='" + combo_composto.getSelectedItem() + "' and ESP_TESTE='" + CadTPECTeste1.getText() + "' ";
    ...
    public void updateB() {
        try {
            ...
            Connection con = new ConexaoSql().getCon();
            String sql = "UPDATE Ficha_Controle set MINIMO=?,MAXIMO=?,ESPEC_COMPLETO=? where ESP_COMPOSTO='" + combo_composto.getSelectedItem() + "' and ESP_TESTE='" + CadTPECTeste2.getText() + "' ";
            PreparedStatement pst = con.prepareStatement(sql);
            pst.setString(1, jTextField4.getText());
            pst.setString(2, jTextField2.getText());
            pst.setString(3, jTextField1.getText());
    ...
    public void updateC() {
        try {
            ...
            Connection con = new ConexaoSql().getCon();
            String sql = "UPDATE Ficha_Controle set MINIMO=?,MAXIMO=?,ESPEC_COMPLETO=? where ESP_COMPOSTO='" + combo_composto.getSelectedItem() + "' and ESP_TESTE='" + CadTPECTeste3.getText() + "' ";
            PreparedStatement pst = con.prepareStatement(sql);
            pst.setString(1, jTextField4.getText());
            pst.setString(2, jTextField2.getText());
            pst.setString(3, jTextField1.getText());
    ...
    public void updateD() {
        try {
            ...
            Connection con = new ConexaoSql().getCon();
            String sql = "UPDATE Ficha_Controle set MINIMO=?,MAXIMO=?,ESPEC_COMPLETO=? where ESP_COMPOSTO='" + combo_composto.getSelectedItem() + "' and ESP_TESTE='" + CadTPECTeste4.getText() + "' ";
            PreparedStatement pst = con.prepareStatement(sql);
            pst.setString(1, jTextField4.getText());
            pst.setString(2, jTextField2.getText());
            pst.setString(3, jTextField1.getText());
    ...
    public void updateE() {
        try {
            ...
            Connection con = new ConexaoSql().getCon();
            String sql = "UPDATE Ficha_Controle set MINIMO=?,MAXIMO=?,ESPEC_COMPLETO=? where ESP_COMPOSTO='" + combo_composto.getSelectedItem() + "' and ESP_TESTE='" + CadTPECTeste5.getText() + "' ";
            PreparedStatement pst = con.prepareStatement(sql);
            pst.setString(1, jTextField4.getText());
            pst.setString(2, jTextField2.getText());
            pst.setString(3, jTextField1.getText());
    ...
    public void updateF() {
        try {
            ...
            Connection con = new ConexaoSql().getCon();
            String sql = "UPDATE Ficha_Controle set MINIMO=?,MAXIMO=?,ESPEC_COMPLETO=? where ESP_COMPOSTO='" + combo_composto.getSelectedItem() + "' and ESP_TESTE='" + CadTPECTeste6.getText() + "' ";
            PreparedStatement pst = con.prepareStatement(sql);
            pst.setString(1, jTextField4.getText());
            pst.setString(2, jTextField2.getText());
            pst.setString(3, jTextField1.getText());
    ...
    private void initComponents() {
        ...
        combo_composto = new javax.swing.JComboBox<>();
        ...
        combo_composto.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        combo_composto.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                combo_compostoPropertyChange(evt);
            }
        });
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(combo_composto, javax.swing.GroupLayout.PREFERRED_SIZE, 118, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(jLabel1)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(combo_composto, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(jLabel2)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void combo_compostoPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_combo_compostoPropertyChange
        combo_composto.addItemListener(new ItemListener() {
            @Override
            public void itemStateChanged(ItemEvent e) {
                if (e.getStateChange() == ItemEvent.SELECTED) {
                    if (combo_composto.getSelectedItem().equals("Selecione...")) {
                        PreencherTabela();
                    } else {
                        PreencherTabela(combo_composto.getSelectedItem().toString());
                    }
                }
            }
        });

    }//GEN-LAST:event_combo_compostoPropertyChange
...
//            JOptionPane.showMessageDialog(null, e);
    ...
    private javax.swing.JComboBox<String> combo_composto;
