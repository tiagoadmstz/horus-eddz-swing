...
import com.cooperstandard.views.acabamento.ViewGerarRodape;
import com.cooperstandard.views.acabamento.ViewMaterialAc;
import com.cooperstandard.views.acabamento.ViewTesteAc;
import com.cooperstandard.views.acabamento.ViewUnidFreqAc;
import com.cooperstandard.views.acabamento.ViewUnidMedAc;
 ...
 * @author rsouza10
 */
public class ViewFichaControleQualidadeAc extends javax.swing.JFrame {

    private static final long serialVersionUID = -5940869691058458993L;

    ModelFichaControleQualidade modelFichaControleQualidade = new ModelFichaControleQualidade();
    ControllerFichaControleQualidadeAc controllerFichaControleQualidade = new ControllerFichaControleQualidadeAc();
    ...
    public ViewFichaControleQualidadeAc() {
        initComponents();
    }

    public ViewFichaControleQualidadeAc(String _perfil, String _linha, String _status, String _responsavel, String _divisao) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lbObservacaoQL.setText("Observação de Alteração para Qualidade:");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtOrdem, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addGap(13, 13, 13)
                                        .addComponent(cbUnidFreq, javax.swing.GroupLayout.PREFERRED_SIZE, 239, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(6, 6, 6)
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txtAmostra, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(10, 10, 10)
                                .addComponent(txtObservacaoQL, javax.swing.GroupLayout.DEFAULT_SIZE, 283, Short.MAX_VALUE)))
                        .addGap(9, 9, 9)))
                .addContainerGap())
        );
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(cbUnidFreq, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(lbProduto)
        ...
        tbFicha.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Ordem", "Linha", "Perfil", "Equipamento", "Desc. Teste", "Cod. Teste", "Obseração", "Tipo", "Espec. Mín.", "Espec. Máx.", "Espec. Unid.", "Espec. Texto", "Referência", "Frequência", "Freq. Unid.", "Produto", "Origem", "Lab.", "Amostra", "IDENTIFICACAO"
            }
        ) {
        ...
        jMenu1.setText("Voltar para Acabamento");
    ...
    private void cbEquipamentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbEquipamentoActionPerformed
        ...
        try {
            ...
            String query1 = "Select * from Qry_Teste where TES_EQUIPAMENTO= ? and OPE_SETOR='Acabamento' order by DESC_TESTE asc";
...
//        }
    ...
    private void jLabel11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel11MouseClicked
        ViewTesteAc vm = null;
        if (ControleInstancias.isInstaced(ViewTesteAc.class)) {
            vm = (ViewTesteAc) ControleInstancias.getInstance(ViewTesteAc.class.getName(), ViewTesteAc.class);
            vm.setSolicitante(this);
        } else {
            vm = new ViewTesteAc(this);
        }
        vm.setVisible(true);
    ...
    private void jLabel12MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel12MouseClicked
        ...
        if (respsota.equals("Material")) {
            ViewMaterialAc vm = null;
            if (ControleInstancias.isInstaced(ViewMaterial.class)) {
                vm = (ViewMaterialAc) ControleInstancias.getInstance(ViewMaterialAc.class.getName(), ViewMaterialAc.class);
                vm.setSolicitante(this);
            } else {
                vm = new ViewMaterialAc(this);
            }
            vm.setVisible(true);
        } else {
    ...
    private void jLabel13MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel13MouseClicked
        ViewUnidMedAc vm = null;
        if (ControleInstancias.isInstaced(ViewUnidMedAc.class)) {
            vm = (ViewUnidMedAc) ControleInstancias.getInstance(ViewUnidMedAc.class.getName(), ViewUnidMedAc.class);
            vm.setSolicitante(this);
        } else {
            vm = new ViewUnidMedAc(this);
        }
        vm.setVisible(true);
    }//GEN-LAST:event_jLabel13MouseClicked

    private void jLabel14MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel14MouseClicked
        ViewUnidFreqAc vm = null;
        if (ControleInstancias.isInstaced(ViewUnidFreqAc.class)) {
            vm = (ViewUnidFreqAc) ControleInstancias.getInstance(ViewUnidFreqAc.class.getName(), ViewUnidFreqAc.class);
            vm.setSolicitante(this);
        } else {
            vm = new ViewUnidFreqAc(this);
        }
        vm.setVisible(true);
    ...
    private void cbTesteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbTesteActionPerformed
        ...
        try {
            ...
            Connection con = new ConexaoSql().getCon();
            String query1 = "Select * from Qry_Teste where DESC_TESTE=? and TES_EQUIPAMENTO=? and OPE_SETOR='Acabamento' order by ORDEM asc";
            PreparedStatement st = con.prepareStatement(query1);
        ...
        cbTeste.addItemListener(new ItemListener() {
            ...
            public void itemStateChanged(ItemEvent e) {
                if (e.getStateChange() == ItemEvent.SELECTED) {
                    ...
                    } else if (cbTeste.getSelectedItem().toString().contains("Validade do Composto")) {
                        txtObs.setText("Conforme Etiqueta");
                    } else if (cbTeste.getSelectedItem().toString().contains("Presença da Etiqueta")) {
                        txtObs.setText("Número da HU / UC (Unidade Comercial)");
                    } else if (cbTeste.getSelectedItem().toString().contains("Data do Composto")) {
                        txtObs.setText("Conforme Etiqueta");
                    } else if (cbTeste.getSelectedItem().toString().contains("Cartão da 1º Peça")) {
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        int p = JOptionPane.showConfirmDialog(null, "Você realmente deseja enviar de volta para setor de Acabamento?", "Enviar", JOptionPane.YES_NO_OPTION);
        if (p == 0) {
            updatStatus();
            dispose();
        }
        ...
        Thread t = new Thread() {
            public void run() {
                ...
                try {
                    ...
                    JasperReport jr = (JasperReport) JRLoader.loadObject(getClass().getResource("/Relatorios/fichacontroleEspecAc.jasper"));
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        ...
        if (p == 0) {
            // Gera Rodapé
            new ViewGerarRodape(Integer.parseInt(perfil), "Novo").setVisible(true);
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        ...
        if (p == 0) {
            // Gera Rodapé
            new ViewGerarRodape(Integer.parseInt(perfil), "Alteracão").setVisible(true);
            updateFichaControle();
        }
    }//GEN-LAST:event_jMenuItem4ActionPerformed

    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
        getValorOrdena().stream().forEach(mr -> controllerFichaControleQualidade.atualizarFichaControleQualidadeAcController((ModelFichaControleQualidade) mr));
    ...
    private void excluirTeste() {
        ...
        if (opcao == JOptionPane.OK_OPTION) {
            if (controllerFichaControleQualidade.excluirFichaControleQualidadeAcController(codigo)) {
...
//            modelFichaControleQualidade.setStatus("");
            if (controllerFichaControleQualidade.updateStatusFichaControleQualidadeAcController(modelFichaControleQualidade, perfil)) {
    ...
    private boolean updateProducaoStatus() {
        for (int i = 0; i < tbFicha.getRowCount(); i++) {
            ...
            if (controllerFichaControleQualidade.updateProducaoStatusFichaControleQualidadeAcController(modelFichaControleQualidade, perfil)) {
                //Copia para tabela historico
                controllerFichaControleQualidade.CopiaHistoricoControleQualidadeAcController(perfil);
                //copia para tabela fichacontrole
                controllerFichaControleQualidade.CopiaFichaControleQualidadeAcController(perfil);
                //deleta da tabela local
                controllerFichaControleQualidade.DeletaFichaControleQualidadeAcController(perfil);
                JOptionPane.showMessageDialog(this, "Registros enviado com sucesso!");
                this.desabilitarCampos();
                this.carregaFichaControle();
                limparDados();
    ...
    private boolean updateFichaControle() {
        for (int i = 0; i < tbFicha.getRowCount(); i++) {
            modelFichaControleQualidade.setPendencia_alter("Produção");
            if (controllerFichaControleQualidade.DeletaFichaControleProducaoQualidadeAcController(perfil)) {
                //deleta ficha de controle produção
                controllerFichaControleQualidade.DeletaFichaControleProducaoQualidadeAcController(perfil);
                //deleta testes removidos = 6
                controllerFichaControleQualidade.DeletaTesteRemovidoQualidadeAcController(perfil);
                //copia para tabela fichacontrole
                controllerFichaControleQualidade.CopiaFichaControleQualidadeAcController(perfil);
                //Coloca data e hora da alteração
                controllerFichaControleQualidade.DataAlteracaoQualidadeAcController(perfil);
                //Copia para tabela historico
                controllerFichaControleQualidade.CopiaHistoricoControleQualidadeAcController(perfil);
                //deleta da tabela local
                controllerFichaControleQualidade.DeletaFichaControleQualidadeAcController(perfil);
    ...
    private boolean alterarExcluir() {
        ...
        try {
            ...
            Logger.getLogger(ViewFichaControleQualidadeAc.class.getName()).log(Level.SEVERE, null, ex);
        }

        if (controllerFichaControleQualidade.atualizarFichaControleQualidadeAcController(modelFichaControleQualidade)) {
            JOptionPane.showMessageDialog(this, "Registro excluido com sucesso!");
            this.desabilitarCampos();
            this.carregaFichaControle();
            limparDados();
    ...
    private boolean salvarFicha() {
        ...
        modelFichaControleQualidade.setAmostra(this.txtAmostra.getText());
        ...
        if (controllerFichaControleQualidade.salvarFichaControleQualidadeAcController(modelFichaControleQualidade) > 0) {
    ...
    private boolean recuperarFichaControle() {
        ...
        int codigo = (Integer) tbFicha.getValueAt(linhatb, 0);
        try {
            modelFichaControleQualidade = controllerFichaControleQualidade.getFichaControleQualidadeAcController(codigo);
            ...
            this.txtAmostra.setText(modelFichaControleQualidade.getAmostra());
            return true;
        } catch (Exception e) {
    ...
    private void carregaFichaControle() {
        if (divisao.equals("Novo") || divisao.equals("Cópia")) {
            listaModelFichaControleQualidade = controllerFichaControleQualidade.getListaFichaControleQualidadeAcController(perfil);
        }
        if (divisao.equals("Alteração")) {
            listaModelFichaControleQualidade = controllerFichaControleQualidade.getListaFichaControleQualidadeAcEditController(perfil);
        }
        ...
        for (int i = 0; i < cont; i++) {
            modelo.addRow(new Object[]{
                ...
                listaModelFichaControleQualidade.get(i).getAmostra(),
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewFichaControleQualidadeAc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewFichaControleQualidadeAc().setVisible(true);
            }
        });
    }
