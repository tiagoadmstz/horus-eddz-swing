...
public class ChartUtil2 {
    ...
    public ChartPanel createXYChart(List<DdzDataChart> ddzDataList, Integer lowMeta, Integer halfMeta, Integer[] hightMeta) {
        ...
        TimeSeries[] series = {new TimeSeries("DDZ"), new TimeSeries("Meta1"), new TimeSeries("Meta2"), new TimeSeries("Meta3")};
        ...
        JFreeChart timechart = ChartFactory.createTimeSeriesChart(
                "LINHA 19 - PESTANA EXTERNA DIANTEIRA E TRASEIRA - I TURNO",
                "Tempo", "Metros",
